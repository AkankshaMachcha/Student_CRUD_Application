...
<div class="container-fluid display-table">
        <div class="row display-table-row">
            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                <div class="navi">
                    <ul>
                    	<li style="color:White;"><a><i  aria-hidden="true">
  ...
  <path fill-rule="evenodd" d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5v-.5zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0zM6 9.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1H6z"/>
                        ...
                        <li><a href="DisplayAllStudent"><i  aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor" class="bi bi-bag-fill" viewBox="0 0 16 16">
  <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5z"/>
</svg></i><span class="hidden-xs hidden-sm">Student Data</span></a></li>
                        <li class="active"><a href="UpdateStudent.html"><i aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="20" fill="currentColor" class="bi bi-bag-check-fill" viewBox="0 0 16 16">
...
<%!Student s=null; %>
            ...
            <div class="col-md-12 col-sm-11 my-auto position-abolute">
...
<%
	...
	if(!session.isNew()){
		...
		s=(Student)o;
		String id=s.getStdId();
		session.setAttribute("id", id);
	}
%>
	      
            
<form class="row g-3 container-sm w-75 mx-auto" action="StudentUpdateServlet">
	<div class="col-12">
		<h3 class="text" style="font-family:FontAwesome;color:#0e1a35;">Student Update</h3>
	</div>
	<div class="col-md-4">
    <label for="inputFname" class="form-label">First Name</label>
    <input type="text" disabled value="<%=s.getFirstName() %>" name="inputFname"  class="form-control" id="inputFname" aria-label="First name">

  </div>
   <div class="col-md-4">
    <label for="inputMname" class="form-label">Father's Name</label>
    <input type="text" id="inputMname" disabled value="<%=s.getFatherName() %>" name="inputMname" class="form-control">
  </div>
  <div class="col-md-4">
    <label for="inputLname" class="form-label">Last Name</label>
    <input type="text" id="inputLname" disabled value="<%=s.getLastName() %>" name="inputLname" class="form-control" id="inputLname">
  </div>
  <div class="col-md-6">
    <label for="inputEmail4" class="form-label">Email</label>
    <input type="email" disabled value="<%=s.getEmail() %>" name="inputEmail" class="form-control" id="inputEmail4">
  </div>
  <div class="col-md-6">
    ...
    <input type="text" name="inputTelephone" class="form-control" id="inputEmail4">
  </div>
  <div class="col-md-6">
    <label for="inputPassword4" class="form-label">Date of Birth</label>
 <input type="date" name="inputDOB" disabled value="<%=s.getDateOfBirth() %>" style="color:#0D6EFD;" class="form-control" id="from-datepicker"> 
  ...
  <div class="col-md-4">
    ...
    <select id="inputState" style="color:#0D6EFD;"  name="inputState" class="form-select">
  ...
  <div class="col-12">
    <button type="submit" id="reg-btn" class="btn btn-primary" style="background-color:#0e1a35;">Update</button>
  </div>
</form>
